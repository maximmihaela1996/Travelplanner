...
namespace Travelpal
{
    ...
    {
        //Create a new instans of userManager
        ...
        private void btnRegister_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (CheckInputs())
            {
                ...
                //If CheckInputs return true --> Create a new user 
                ...
                {
                    MessageBox.Show("Congratulations! You have successfully registered! Now you can plan your trip", "Success!");
                    this.Close(); 
                }else
                {
        ...
        private bool CheckInputs()
        {
            ...
            {
                //booleans that return if the conditions in the method ValidateNewUser are fulfilled 
                ...
                }else
                {
                    ...
                    MessageBox.Show("The Username must be at least 3 characters and password 5 characters!");
                    return false;
                }
            }else{
